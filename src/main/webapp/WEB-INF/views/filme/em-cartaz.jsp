...
https://cursos.alura.com.br/forum/topico-aula5-37997
...
<ingresso:template>
	<jsp:body>
		...
		<style>
			...
			.painel{ transition: transform 0.7s;}
			.panel:hover{ transform: translateY(-0.5em);}
			.panelSize{ min-height:10.5em; min-width:13em;}
		</style>
	</jsp:body>
</ingresso:template>